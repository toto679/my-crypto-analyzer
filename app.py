...
if uploaded_file:
    ...
    # 4. Годишни (Твоят код + НОВИТЕ екстри)
    with tabs[3]:
        ...
        # Умно оцветяване на твоята таблица
        def style_growth(s):
